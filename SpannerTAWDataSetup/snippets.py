...
def insert_data(instance_id, database_id):
    ...
    with database.batch() as batch:
        batch.insert(
            ...
            values=[
                (1, u'ofelia', u'Rushsorth', base64.b64encode('Thirteen-Lined squirrel')),
                (2, u'Leeland', u'Cleaves',base64.b64encode('Gull herring')),
                (3,u'Meaghan', u'Calveley', base64.b64encode('Four-horned antelope')),
                (4,u'Gracia', u'Tierny', base64.b64encode('Sage hen')),
                (5, u'Dorie', u'Vardie', base64.b64encode('Lion australian sea'))])

        batch.insert(
            table='Albums',
            columns=('SingerId', 'AlbumId', 'AlbumTitle'),
            values=[
                (4,2, u'Insight Pharmaceuticals LLC'),
                (3,1, u'Roxane Laboratories, Inc.'),
                (1,1, u'Roxane Laboratories, Inc.'),
                (4,3, u'Ranbaxy Pharmaceuticals Inc.'),
                (2,2, u'STAT RX USA LLC')])

        batch.insert(
            table='Songs',
            columns=('SingerId', 'AlbumId', 'TrackId', 'SongName', 'Duration', 'SongGenre'),
            values=[
                (4, 2, 1, u'Phalacrocorax varius', 74, u'pop'),
                (1, 1, 2, u'Cacatua tenuirostris', 247, u'jazz'),
                (3, 1, 3, u'Procyon lotor', 282, u'rap'),
                (4, 3, 4, u'Bucephala clangula', 185, u'pop'),
                (2, 2, 5, u'Butorides striatus', 107, u'rock'),
                (4, 2, 6, u'Canis aureus', 177, u'classic'),
                (1, 1, 7, u'Ctenophorus ornatus', 287, u'jazz'),
                (4, 3, 8, u'Buteo regalis', 263, u'pop'),
                (2, 2, 9, u'Cacatua tenuirostris', 265, u'rock'),
                (4, 3, 10, u'Canis dingo', 72, u'pop')])

        batch.insert(
            table='Concerts',
            columns=('VenueId', 'SingerId', 'ConcertDate', 'BeginTime', 'EndTime', 'TicketPrices'),
 values=[
                (3,3, datetime.datetime.now().date(), datetime.datetime.now(), datetime.datetime.now(), [334]*7),
                (2,4, datetime.datetime.now().date(), datetime.datetime.now(), datetime.datetime.now(), [100] * 7 ),
                (1,4, datetime.datetime.now().date(), datetime.datetime.now(), datetime.datetime.now(), [45] * 7 ),
                (4,1, datetime.datetime.now().date(), datetime.datetime.now(), datetime.datetime.now(), [12] * 7 )])
    print('Inserted data.')
...
def query_data_with_index(
        instance_id, database_id, start_title='Roxane Laboratories, Inc.', end_title='z'):
